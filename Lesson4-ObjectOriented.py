...
class CoolerFrame(wx.Frame):
	...
	def __init__(self, parent):
		...
		heading = wx.heading = wx.StaticText(self.panel, label="Please Click Me", pos=(20,5))
...
class MoreCoolerFrame(wx.Frame):
	# Remember __init__ is the constructor function. It sets up or "initializes" the new CoolerFrame
	def __init__(self, parent):
		...
		self.btnClickMe = wx.Button(self.panel, label="Click Me", pos=(20,70))
		
		self.btnClickMe.Bind(wx.EVT_BUTTON, self.DontClickMe)
		
		heading = wx.heading = wx.StaticText(self.panel, label="Please NOT Click Me", pos=(20,55))

	def DontClickMe(self, e):
		print "No, How can you click it!"
...
VincentFrame = MoreCoolerFrame(None)
